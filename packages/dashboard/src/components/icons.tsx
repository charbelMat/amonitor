...
/** Minimal 16px stroke icon set — avoids pulling in an icon dependency. */
...
export const IssuesIcon = (p: SVGProps<SVGSVGElement>) => (
  <Icon {...p}>
...
export const UptimeIcon = (p: SVGProps<SVGSVGElement>) => (
  <Icon {...p}>
    <path d="M22 12h-4l-3 9L9 3l-3 9H2" />
  </Icon>
);

export const AlertsIcon = (p: SVGProps<SVGSVGElement>) => (
  <Icon {...p}>
